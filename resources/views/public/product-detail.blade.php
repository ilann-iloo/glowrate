...
<div class="product-detail-page">
    ...
    <div class="row g-4 align-items-stretch">
        ...
        <div class="col-lg-7">
            <div class="soft-card product-info-card h-100">
    ...
    {{-- FORM REVIEW --}}
    <div class="soft-card review-form-card mt-4">
        ...
        @auth
            ...
            @else
                ...
                <div class="alert alert-info mb-0">
                    Admin tidak dapat memberikan review produk.
                </div>
    ...
    {{-- DAFTAR REVIEW --}}
    <div class="soft-card review-list-card mt-4">
        ...
        @forelse ($product->activeReviews as $review)
            ...
            <div class="single-review-item"
                style="background-color:#fff7f5;border-radius:16px;padding:16px 20px;margin-bottom:12px;">
